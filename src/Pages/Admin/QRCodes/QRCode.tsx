...
import { Calendar, Download, Edit2, Link as LinkIcon, PieChart, QrCode as QRCodeIcon, Trash2 } from 'lucide-react';
...
const QRCode = ({ code }: IQRCodeComponent) => {
  return (
    <div className='bg-gray-50 p-6'>
      <div className='flex justify-between'>
        ...
        <div className='flex gap-2'>
          <Button className='w-12 h-12 rounded-full p-0 shadow-lg' variant="outline"><Edit2 className='w-5' /></Button>
          <Button className='w-12 h-12 rounded-full p-0 shadow-lg'><Trash2 className='w-5' /></Button>
        </div>
      </div>
    </div>
  )
